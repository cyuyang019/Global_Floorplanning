...
global_floorplan: main.o parser.o globmodule.o rgsolver.o cluster.o
...
global_floorplan_debug: main_db.o parser_db.o globmodule_db.o rgsolver_db.o cluster_db.o
